...
$PATH_TO_ANSIBLE_SETUP_FILE $ANSIBLE_UN $ANSIBLE_PWD $PROG_USER_SELECTION $PROG_USER_PWD $PATH_TO_SLAVES_FILE $SHOW_EXPECT_SCRIPT_MSG $LOG_FILES_PATH | tee -a /tmp/ansible-setup1.log
