...
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/0a_compressed_file_setup.yml # | tee -a /tmp/wildfly-setup.log
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/0b_compressed_file_setup.yml # | tee -a /tmp/wildfly-setup.log
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/1_create-user.yml # | tee -a /tmp/wildfly-setup.log
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/2_deploy.yml # | tee -a /tmp/wildfly-setup.log
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/3_start.yml # | tee -a /tmp/wildfly-setup.log
...
ansible-playbook $ANSIBLE_HOME/jboss_wildfly_playbooks/local_playbooks/6_deploy_app1_v01.yml # | tee -a /tmp/wildfly-setup.log